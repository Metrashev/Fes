...
<tr>
	...
	<?/*
	<hr />
		<select  name="node" id='node' size=30 style="width:100%">
			<option value="0">Root
	...
	*/?>
	...
	<fieldset>
		...
		<div align="left" style="padding:2px">
			<input type="submit" name="mvChild" value="Move as child" style="background:url(/be/i/design/move_as_next.png) top left;width:100px;height:20px;border:none;" />
			<input type="submit" name="mvNode" value="Move under as next node" style="background:url(/be/i/design/move_as_next_node.png) top left;width:168px;height:20px;border:none;" />
		</div>
		<div align="left" style="padding:2px">
			<input type="submit" name="btDelete" value="Delete node" onclick="return confDelete1()" class="delete_button" /><br />
		</div>		
	</fieldset>
	</td>
</tr>
	...
	<td colspan="2" align="left">
		...
		<tr>
			<td valign="top" width="200">
				<div style="background:url(/be/i/design/new_node_bgr.png) top left no-repeat;padding:3px 5px;font-size:13px;color:#333333;font-weight:bold;width:186px;">Add new node</div>
				<div style="padding:5px 3px 5px 7px;width:186px;border:1px solid #CCCCCC">
					...
					<input type="submit" style="background:url(/be/i/design/node_add_after.png) top left no-repeat;border:none;width:74px;height:20px;" name="submitadd" value="Add After" /> <input type="submit" style="background:url(/be/i/design/node_add_child.png) top left no-repeat;border:none;width:92px;height:20px;" name="submitaddchild" value="Add as Child" />
				</div>
			</td>
			<td align="left" height="100%" style="background:url(/be/i/design/node_edit_bgr.png) 50% 50% no-repeat;width:96px;padding:5px;">
			<table width="100%" cellpadding="0" cellspacing="0" height="100%" border="0">
			<tr>
				<td colspan="3" align="center" valign="bottom"><input type="submit" name="submitup" value="" style="cursor:hand;width:10px;height:12px;background:url(/be/i/design/arrow_up.png) top left no-repeat;border:none;" /></td>
			</tr>
			<tr>
				<td align="right"><input type="submit" name="submitleft" value="" style="cursor:hand;width:12px;height:10px;background:url(/be/i/design/arrow_left.png) top left no-repeat;border:none;" /></td>
				<td align="center"><input type="submit" name="submitupdate" value="Edit" style="background:url(/be/i/design/button_edit_bgr.png) top left no-repeat;height:20px;width:38px;border:none;"></td>
				<td><input type="submit" name="submitright" value="" style="cursor:hand;width:12px;height:10px;background:url(/be/i/design/arrow_right.png) top left no-repeat;border:none;" /></td>
			</tr>
			<tr>
				<td colspan="3" align="center" valign="top"><input type="submit" name="submitdown" value="" style="cursor:hand;width:10px;height:12px;background:url(/be/i/design/arrow_down.png) top left no-repeat;border:none;" /></td>
			</tr>
