<html>
	...
	<tr class="list_header">
			<td in_index="1" id='_id'  class="header_add"><a  href='/be/static_pages/edit.php?n_cid=<?=$_GET['n_cid'];?>&amp;<?=FE_Utils::getBackLink();?>'>New</a></td>
...
<? if(!isset($_GET['search'])) { ?>
			<a field_name="id"  href='/be/static_pages/edit.php?n_cid=<?=$_GET['n_cid'];?>&amp;id=_#VAL#_&amp;<?=FE_Utils::getBackLink();?>'>Edit</a>
		<?} else { ?>
