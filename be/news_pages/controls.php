...
function getControls($type='edit') {
	...
	$sizes=array(
		'pic'=>array(112,85,"(Основа 112)"),
		'pic2'=>array(302,0,"(Основа 302)"),
	);
	
	if (in_array($_GET['cid'],array(13,21,35,78,79,80))) {
		$sizes=array(
			'pic'=>array(77,0,"(Основа 77)"),
			'pic2'=>array(302,0,"(Основа 302)"),
		);
	}
...
'_to_due_date'=>array(
	'control'=>array("Label"=>"","name"=>"_to_in_data[due_date]","isHTML"=>false,"tagName"=>"DateTimeControl","bound_field"=>"_to_due_date","userFunc"=>"","FormatString"=>"%d/%m/%Y %H:%M",'states'=>array('on'=>1,'off'=>0)),
),
'visible_from_date'=>array(
	'control'=>array("Label"=>"due date","name"=>"in_data[visible_from_date]","isHTML"=>false,"tagName"=>"DateTimeControl","bound_field"=>"visible_from_date","userFunc"=>"","FormatString"=>"%d/%m/%Y %H:%M"),
	'write_data'=>array("type"=>DATA_DATETIME,"required"=>true,),
),
'is_visible'=>array(
...
'source'=>array(
	'control'=>array("Label"=>"source","name"=>"in_data[source]","isHTML"=>false,"tagName"=>"Input","bound_field"=>"source","userFunc"=>"","FormatString"=>""),
	'write_data'=>array("type"=>DATA_VARCHAR,"required"=>false,),
),

'source_href'=>array(
	'control'=>array("Label"=>"source href","name"=>"in_data[source_href]","isHTML"=>false,"tagName"=>"Input","bound_field"=>"source_href","userFunc"=>"","FormatString"=>""),
	'write_data'=>array("type"=>DATA_VARCHAR,"required"=>false,),
),
