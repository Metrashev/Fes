...
<td in_index="1" id='_id'  class="header_add"><a href='/be/news_pages/edit.php?cid=<?=$_GET['id'];?>&amp;<?=FE_Utils::getBackLink();?>'>New</a></td>
...
<? if(!isset($_GET['search'])) { ?>
			<a field_name="id" href='/be/news_pages/edit.php?id=_#VAL#_&amp;<?=FE_Utils::getBackLink();?>'>Edit</a>
		<?} else { ?>
