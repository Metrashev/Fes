...
'target'=>array(
	'control'=>array("Label"=>"target","name"=>"in_data[target]","isHTML"=>false,"tagName"=>"Select","bound_field"=>"target","userFunc"=>"","FormatString"=>"","autoload"=>array("type"=>"arrayname","value"=>array("DataSource"=>array(""=>"","_blank"=>"Blank","_top"=>"Top","_self"=>"Self","_parent"=>"Parent"),))),
	'write_data'=>array("type"=>DATA_VARCHAR,"required"=>false,),
),
