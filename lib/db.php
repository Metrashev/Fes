...
class CDB{
  ...
  /* END za rabota s tranzakcii */
	...
	private function __query($SQL, $params=null){
		if(is_array($params))
		...
		if($rs===false)
		throw new Exception("<p STYLE=\"word-wrap:break-word;width:100%;left:0\"><b>".mysql_errno($this->connection)."</b>:<br/>".mysql_error($this->connection)."<br/>{$SQL}</p>");
