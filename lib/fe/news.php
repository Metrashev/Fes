...
class CBONews extends ABOBase {
	...
	public $fields = array(
		...
		'subtitle'=> array('type'=>'HTML', 'label'=>'Sub Title', 'size'=>255),
		'picture'=> array('type'=>'ManagedImage', 'label'=>'Picture', 'sizes'=>array('pic', 'pic2')),
...
class CBONewsCusom extends CBONews {
	function getFEConstrains(){
		return 'is_visible=1 AND visible_from_date <= now()';
	}	
}
