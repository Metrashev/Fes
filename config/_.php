...
define('DEBUG_MODE', strpos($_SERVER['HTTP_HOST'], 'itti.com')>0);

if(DEBUG_MODE){
	$CONFIG['DSN']="mysql://root:kustendil@localhost/fes-new";
} else {
	$CONFIG['DSN']="mysql://fes-new:fes-new@localhost/fes-new";
}
